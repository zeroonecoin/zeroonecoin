/* src/config/zeroone-config.h.  Generated from zeroone-config.h.in by configure.  */
/* src/config/zeroone-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZEROONE_CONFIG_H

#define ZEROONE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/zeroonecoin/zeroone/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZeroOne Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZeroOne Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zeroonecore"
