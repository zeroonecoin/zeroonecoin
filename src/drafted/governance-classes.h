 ...
 *
 *   // network
 *   CZeroOneNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zeroone.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZeroOneNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CZeroOneNetwork(UniValue objIn)
    {
...
// // can be under: ZeroOneNetwork
// //   -- signature requirements : Key1(User)
// class CZeroOneNetworkVariable : public CGovernanceObject
// {
// private:
