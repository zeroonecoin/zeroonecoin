...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZeroOneNetwork") type = ZeroOneNetwork;
    if(strType == "ZeroOneNetworkVariable") type = ZeroOneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZeroOneNetwork) s = "ZeroOneNetwork";
    if(type == ZeroOneNetworkVariable) s = "ZeroOneNetworkVariable";
