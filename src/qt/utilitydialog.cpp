    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ZeroOne Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ZeroOne Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zeroone-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ZeroOne in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ZOC, 0.1 ZOC, 1 ZOC and 10 ZOC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ZeroOne Core is shutting down...") + "<br /><br />" +
