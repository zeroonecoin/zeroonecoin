    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ZeroOne Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZeroOne address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zeroone: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ZeroOne Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZeroOne Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZeroOne Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZeroOne addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZeroOne addresses"));
    ...
    openAction->setStatusTip(tr("Open a zeroone: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZeroOne Core help message to get a list with possible ZeroOne Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ZeroOne Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZeroOne network", "", count));
}
...
{
    QString strTitle = tr("ZeroOne Core"); // default title
