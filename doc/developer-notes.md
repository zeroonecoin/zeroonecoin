...
ZeroOne Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as ZeroOne Core, where everyone uses
...
pay attention to for reviewers of ZeroOne Core code.

General ZeroOne Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: ZeroOne Core uses tinyformat, which is type safe. Leave them out to avoid confusion
