TOR SUPPORT IN ZOC CORE
=======================

It is possible to run ZeroOne Core as a Tor hidden service, and connect to such services.
...
1. Run ZeroOne Core behind a Tor proxy
----------------------------------

The first step is running ZeroOne Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./zerooned -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./zerooned -proxy=127.0.0.1:9050


2. Run a ZeroOne Core hidden server
-------------------------------
...
your zerooned's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell ZeroOne Core about its publicly reachable address using
	                ...
	                /var/lib/tor/zeroonecore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./zerooned -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./zerooned ... -bind=127.0.0.1
...
ZeroOne Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
ZeroOne Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if ZeroOne Core is listening, and
