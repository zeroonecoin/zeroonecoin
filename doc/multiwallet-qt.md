...
Only requiring some minor changes is zeroone.cpp.
...
Changes to zeroone.cpp
----------------------
zeroone.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
