...
This mechanism has been integrated into Bitcore-Node-ZeroOne which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zeroonecoin/insight-api-zeroone#web-socket-api](https://github.com/zeroonecoin/insight-api-zeroone#web-socket-api) 
* API: [https://github.com/zeroonecoin/insight-api-zeroone#instantsend-transactions](https://github.com/zeroonecoin/insight-api-zeroone#instantsend-transactions) 
...
By default, the ZeroOne Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZeroOne Core daemon:
